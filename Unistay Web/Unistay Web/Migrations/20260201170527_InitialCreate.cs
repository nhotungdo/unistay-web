    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovingRequests", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrls = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsVerifiedTenant = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomFinderRequests", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedStayDuration = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    IdVerificationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    SuccessfulBookings = table.Column<int>(type: "int", nullable: false),
                    NotificationEmailEnabled = table.Column<bool>(type: "bit", nullable: false),
                    NotificationSmsEnabled = table.Column<bool>(type: "bit", nullable: false),
                    NotificationPushEnabled = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    CompatibilityAnalysis = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HouseNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StreetName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsAddressVerified = table.Column<bool>(type: "bit", nullable: false),
                    LandlordVerificationStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Connections_UserProfiles_AddresseeId",
                        column: x => x.AddresseeId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Connections_UserProfiles_RequesterId",
