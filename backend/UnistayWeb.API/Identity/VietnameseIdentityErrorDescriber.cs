...
namespace UnistayWeb.API.Identity
{
    public class VietnameseIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError ConcurrencyFailure()
        {
            return new IdentityError
            {
                ...
                Description = "Lỗi đồng bộ dữ liệu, vui lòng thử lại."
            };
        }
        ...
        public override IdentityError LoginAlreadyAssociated()
        {
            return new IdentityError
            {
                ...
                Description = "Tài khoản này đã được liên kết với một người dùng khác."
            };
        }
        ...
        public override IdentityError InvalidUserName(string userName)
        {
            return new IdentityError
            {
                ...
                Description = $"Tên đăng nhập '{userName}' không hợp lệ, chỉ được chứa chữ cái và số."
            };
        }
        ...
        public override IdentityError UserAlreadyHasPassword()
        {
            return new IdentityError
            {
                ...
                Description = "Người dùng đã cài đặt mật khẩu."
            };
        }
        ...
        public override IdentityError UserLockoutNotEnabled()
        {
            return new IdentityError
            {
                ...
                Description = "Chức năng khóa tài khoản chưa được kích hoạt."
            };
        }
